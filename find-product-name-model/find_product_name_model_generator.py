...
# python find_product_name_model_generater.py
...
dataset = load_custom_dataset("findProdName-io.json")  # JSON dosyasının yolunu belirt
...
training_args = TrainingArguments(
    ...
    num_train_epochs=100,  # İlk başta az epoch denemek faydalı olabilir
    weight_decay=0.01,
    logging_dir='./logs',
    logging_steps=10,
